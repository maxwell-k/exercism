...
void main() {
  ...
  group(
    'Allergies: testing for shellfish allergy - ',
    testingForShellfishAllergy,
  );
  group(
    'Allergies: testing for strawberries allergy - ',
    testingForStrawberriesAllergy,
  );
  group(
    'Allergies: testing for tomatoes allergy - ',
    testingForTomatoesAllergy,
  );
  group(
    'Allergies: testing for chocolate allergy - ',
